...
from app.models.api import MediaListResponse, MediaType, PipelineStatus, RejectionStatus, MediaPipelineUpdateRequest, MediaPipelineUpdateResponse, PredictionListResponse
import logging
...
def get_router():
    ...
    @router.get("/prediction", response_model=PredictionListResponse)
